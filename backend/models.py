...
class PosCashPullout(models.Model):
    ...
    terminal_no = models.CharField(max_length=50, default='')
    datetime_stamp = models.CharField(max_length=30, default='0')
    pullout_by = models.IntegerField(default=0)
...
class PosCashPulloutDetails(models.Model):
    trans_id = models.IntegerField(default=0)
    details_id = models.IntegerField(primary_key=True)
    quantity = models.IntegerField(default=0)
    denomination = models.CharField(max_length=20, default='0')
    total = models.DecimalField(max_digits=15, decimal_places=3, null=True)
